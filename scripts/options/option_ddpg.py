...
class Options():
    ...
    def __init__(self):
        ...
        parser.add_argument('--output_name', help='Name used as base for all the output files.', type=str, default='ddpg_model')
        ...
        parser.add_argument('--goal_distance_tolerance', type=float, default=0.5, help='Tolerance to consider that robot has reached the goal.')
